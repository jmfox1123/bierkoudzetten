...
//config
$host = 'localhost';
$username = 'mick@bierkoudzetten.nl'; //username or ftp username
$password = 'kv4M8dTh'; //password or ftp password
$dir = '/domains/'; //path to files e.g. dirname(__FILE__).'/';
$server_type = 'ftp'; //local, ftp or sftp. local requires webserver to have write permissions to files.
$pasv = '1'; //pasv mode for ftp
